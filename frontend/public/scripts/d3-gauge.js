  ...
  return (function n(t, e, r) {
  ...
  })(
    {
      1: [
          ...
          function r(n, t) {
            return this instanceof r
              ? ((this._el = n),
                ...
                (this._needleContainerRadiusRatio =
                  this._opts.needleContainerRadiusRatio),
          ...
          (a.write = function (n, t) {
            function e() {
              var t = n,
                ...
                i = n < r._min;
              e
                ? (t = r._max + 0.02 * r._range)
                : i && (t = r._min - 0.02 * r._range);
              var o = r._toDegrees(t) - 90,
                u = r._currentRotation || o;
              return (
                (r._currentRotation = o),
                function (n) {
                  var t = u + (o - u) * n;
                  return (
                    "translate(" + r._cx + ", " + r._cy + ") rotate(" + t + ")"
                  );
                }
              );
            }
            ...
            o.transition()
              .duration(t ? t : this._transitionDuration)
              .attrTween("transform", e);
          }),
            (a._initZones = function () {
              ...
              function t(t) {
                return { clazz: t.clazz, from: n(t.from), to: n(t.to) };
              }
              var e = this;
            ...
            (a._initGauge = function () {
              this._gauge = u
                ...
                .attr(
                  "class",
                  "d3-gauge" + (this._clazz ? " " + this._clazz : "")
                )
                ...
                .attr(
                  "preserveAspectRatio",
                  this._preserveAspectRatio || "xMinYMin meet"
                );
            }),
            ...
            (a._drawTicks = function () {
              for (
                var n,
                  t = this._range / (this._majorTicks - 1),
                  e = t / this._minorTicks,
                  r = this._min;
                r <= this._max;
                r += t
              ) {
                for (
                  var i = Math.min(r + t, this._max), o = r + e;
                  o < i;
                  o += e
                )
                  this._drawLine(
                    this._toPoint(o, 0.75),
                    this._toPoint(o, 0.85),
                    "minor-tick"
                  );
                this._drawLine(
                  this._toPoint(r, 0.7),
                  this._toPoint(r, 0.85),
                  "major-tick"
                ),
                  (r !== this._min && r !== this._max) ||
                    ((n = this._toPoint(r, 0.63)),
                    this._gauge
                      .append("svg:text")
                      .attr("class", "major-tick-label")
                      .attr("x", n.x)
                      .attr("y", n.y)
                      .attr("text-anchor", r === this._min ? "start" : "end")
                      .text(r));
              }
            }),
            ...
            (a._drawBand = function (n, t, e) {
              ...
              var i = this,
                o = u.svg
                  .arc()
                  .startAngle(this._toRadians(n))
                  .endAngle(this._toRadians(t))
            ...
            (a._drawNeedle = function () {
              ...
              n
                ...
                n
                  ...
                  .attr(
                    "r",
                    (this._radius * this._needleContainerRadiusRatio) / 10
                  );
              ...
              n.selectAll("text")
                ...
                .append("svg:text")
                .attr("x", this._cx)
                .attr("y", this._size - this._cy / 4 - i)
                .attr("dy", i / 2)
                .attr("text-anchor", "middle");
            }),
            ...
            (a._toDegrees = function (n) {
              return (
                (n / this._range) * 270 - ((this._min / this._range) * 270 + 45)
              );
            }),
        ...
        { "./defaults/simple": 2, d3: 4, xtend: 6 },
      ],
      2: [
        function (n, t, e) {
          "use strict";
      ...
      3: [
        function (n, t, e) {
          d3 = (function () {
            ...
            function s(n) {
              function t() {
                for (var t, r = e, i = -1, o = r.length; ++i < o; )
            ...
            function b(n) {
              ...
              return function (e, r) {
                ...
                r
                  ? ((t.lastIndex = 0),
                    t.test(i) || e.setAttribute("class", m(i + " " + n)))
                  : e.setAttribute("class", m(i.replace(t, " ")));
              };
            }
            function w(n, t, e) {
              function r() {
            ...
            function A(n) {
              return (
                arguments.length || (n = Wo.ascending),
                function (t, e) {
            ...
            function q(n, t, e) {
              ...
              function i() {
                ...
                r.call(this),
                  this.addEventListener(n, (this[u] = i), (i.$ = e)),
                  (i._ = t);
              }
              function o() {
                var t,
                  e = new RegExp("^__on([^.]+)" + Wo.requote(n) + "$");
                for (var r in this)
                  if ((t = r.match(e))) {
                    var i = this[r];
            ...
            function J(n, t, e) {
              return (
                isNaN(n) && (n = 0),
                isNaN(t) && (t = 0),
                K(e, Math.cos((n *= zu)) * t, Math.sin(n) * t)
              );
            }
            function K(n, t, e) {
              return new Q(n, t, e);
            ...
            function nn(n, t, e) {
              ...
              return (
                ...
                (o = en(o) * Yu),
                cn(
                  on(3.2404542 * i - 1.5371385 * r - 0.4985314 * o),
                  on(-0.969266 * i + 1.8760108 * r + 0.041556 * o),
                  on(0.0556434 * i - 0.2040259 * r + 1.0572252 * o)
                )
              );
            }
            function tn(n, t, e) {
              return n > 0
                ? W(Math.atan2(e, t) * Tu, Math.sqrt(t * t + e * e), n)
                : W(NaN, NaN, n);
            }
            function en(n) {
            ...
            function pn(n, t, e) {
              ...
              var r = rn((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Hu),
                i = rn((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Iu),
                o = rn((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Yu);
            ...
            function Mn() {
              var n = bn(),
                t = wn() - n;
              t > 24
                ? (isFinite(t) && (clearTimeout(Gu), (Gu = setTimeout(Mn, t))),
                  (Wu = 0))
                : ((Wu = 1), Ku(Mn));
            }
            function bn() {
              var n = Date.now();
              for (Ju = Xu; Ju; )
                n >= Ju.t && (Ju.f = Ju.c(n - Ju.t)), (Ju = Ju.n);
              return n;
            }
            function wn() {
              for (var n, t = Xu, e = 1 / 0; t; )
                t.f
                  ? (t = n ? (n.n = t.n) : (Xu = t.n))
                  : (t.t < e && (e = t.t), (t = (n = t).n));
              return ($u = n), e;
                  ...
                  m = {
                    ...
                    polygonEnd: function () {
                      ...
                      p.length
                        ? Xn(p, Qn, n, e, o)
                        : n &&
                          (o.lineStart(), e(null, null, 1, o), o.lineEnd()),
                        o.polygonEnd(),
                        (p = g = null);
                    },
                    sphere: function () {
            ...
            function Qn(n, t) {
              return (
                ((n = n.x)[0] < 0 ? n[1] - Nu - Au : Nu - n[1]) -
                ((t = t.x)[0] < 0 ? t[1] - Nu - Au : Nu - t[1])
              );
            }
            function nt(n, t) {
              var e = n[0],
              ...
              for (var a = 0, c = t.length; a < c; ++a) {
                ...
                if (s)
                  for (
                    ...
                    if (
                      (ha.add(
                        Math.atan2(w * Math.sin(M), d * _ + w * Math.cos(M))
                      ),
                      (o += b ? M + (M >= 0 ? Eu : -Eu) : M),
                      b ^ (h >= e) ^ (y >= e))
                    ) {
            ...
            function et(n, t, e, r) {
              ...
              return au(u) > Au
                ? Math.atan(
                    (Math.sin(t) * (o = Math.cos(r)) * Math.sin(e) -
                  ...
                  if (((o = e - c), g || !(o < 0))) {
                    ...
                    if (((o = t - l), d || !(o > 0))) {
                      ...
                      if (((o = r - l), d || !(o < 0))) {
                        ...
                        return (
                          h > 0 && (i.a = { x: c + h * g, y: l + h * d }),
                          p < 1 && (i.b = { x: c + p * g, y: l + p * d }),
                          i
                        );
                      }
                    }
              ...
              return function (a) {
                function c(n) {
                  for (var t = 0, e = y.length, r = n[1], i = 0; i < e; ++i)
                    for (
                      var o, u = 1, a = y[i], c = a.length, s = a[0];
                      u < c;
                      ++u
                    )
                      (o = a[u]),
                ...
                function g() {
                  v && (d(x, _), M && k && A.rejoin(), v.push(A.buffer())),
                    (z.point = h),
                    k && a.lineEnd();
                }
                function d(n, t) {
                  (n = Math.max(-Na, Math.min(Na, n))),
                    (t = Math.max(-Na, Math.min(Na, t)));
                  var e = f(n, t);
                  if ((y && m.push([n, t]), S))
                    (x = n),
                      (_ = t),
                    ...
                    C(r)
                      ? (k || (a.lineStart(), a.point(r.a.x, r.a.y)),
                        a.point(r.b.x, r.b.y),
                        e || a.lineEnd(),
                        (E = !1))
              ...
              function i(t, e, r, a, c, l, s, f, h, p, g, d, v, y) {
                ...
                if (_ > 4 * o && v--) {
                  var M = a + p,
                    ...
                    L = x * z - m * T;
                  ((L * L) / _ > o ||
                    au((m * z + x * T) / _ - 0.5) > 0.3 ||
                    a * p + c * g + l * d < u) &&
                    (i(t, e, r, a, c, l, A, C, E, (M /= k), (b /= k), w, v, y),
                    y.point(A, C),
                    i(A, C, E, M, b, w, s, f, h, p, g, d, v, y));
                }
              }
              var o = 0.5,
                u = Math.cos(30 * zu),
            ...
            function kt(n) {
              function t(n) {
                return (
                  (n = a(n[0] * zu, n[1] * zu)), [n[0] * h + c, l - n[1] * h]
                );
              }
              function e(n) {
                return (
              ...
              return (
                ...
                (t.clipAngle = function (n) {
                  return arguments.length
                    ? ((_ = null == n ? ((b = n), Ea) : it((b = +n) * zu)), i())
                    : b;
                }),
                (t.clipExtent = function (n) {
                  return arguments.length
                    ? ((w = n),
                      (M = n ? ut(n[0][0], n[0][1], n[1][0], n[1][1]) : yn),
                      i())
                    : w;
                }),
                (t.scale = function (n) {
            ...
            function Lt(n, t) {
              ...
              return function (i, o, u, a) {
                ...
                for (var l, s = i; u > 0 ? s > o : s < o; s -= c)
                  a.point(
                    (l = On([e, -r * Math.cos(s), -r * Math.sin(s)]))[0],
                    l[1]
                  );
              };
            }
              ...
              var i = Math.cos(t),
                ...
                g = h
                  ? function (n) {
                      ...
                      return [
                        Math.atan2(i, r) * Tu,
                        Math.atan2(u, Math.sqrt(r * r + i * i)) * Tu,
                      ];
                    }
                  : function () {
                      return [n * Tu, t * Tu];
            ...
            function Ot() {
              function n(n, i) {
                ...
                (Pa += Math.atan2(
                  Math.sqrt(
                    (a = u * Math.sin(a)) * a + (a = r * o - e * u * c) * a
                  ),
                  e * o + r * u * c
                )),
                  (t = n),
            ...
            function Ht(n, t) {
              ...
              return o
                ? ((e.invert = function (n, t) {
                    ...
                    return [
                      Math.atan2(n, e) / o,
                      2 * Math.atan(Math.pow(u / r, 1 / o)) - Nu,
                    ];
                  }),
                  e)
                : Yt;
            ...
            function te(n) {
              ...
              for (
                var c = o;
                c.circle && au(e - c.circle.x) < Au && au(r - c.circle.cy) < Au;

              )
                (o = c.P), a.unshift(c), ne(c), (c = o);
              a.unshift(c), se(c);
              for (
                var l = u;
                l.circle && au(e - l.circle.x) < Au && au(r - l.circle.cy) < Au;

              )
                (u = l.N), a.push(l), ne(l), (l = u);
              a.push(l), se(l);
              var s,
                f = a.length;
              for (s = 1; s < f; ++s)
                (l = a[s]), (c = a[s - 1]), ve(l.edge, c.site, l.site, i);
              (c = a[0]),
                (l = a[f - 1]),
            ...
            function ee(n) {
              ...
              if ((Xa.insert(t, c), t || e)) {
                ...
                ve(e.edge, l, g, _),
                  (c.edge = ge(l, n, null, _)),
                  (e.edge = ge(n, g, null, _)),
                  le(t),
                  le(e);
              }
            }
            ...
            function ue(n) {
              for (
                ...
                if (((o = d[v]), o && o.prepare()))
                  for (a = o.edges, c = a.length, u = 0; u < c; )
                    (s = a[u].end()),
                      (r = s.x),
                      (i = s.y),
                      (l = a[++u % c].start()),
            ...
            function fe(n) {
              for (
                ...
                (t = e[i]),
                  (!he(t, n) ||
                    !r(t) ||
                    (au(t.a.x - t.b.x) < Au && au(t.a.y - t.b.y) < Au)) &&
            ...
            function ge(n, t, e, r) {
              ...
              return (
                ...
                e && ve(i, n, t, e),
                r && ve(i, t, n, r),
                Ba[n.i].edges.push(new ye(i, n, t)),
                Ba[t.i].edges.push(new ye(i, t, n)),
                i
              );
            }
            function de(n, t, e) {
            ...
            function we(n, t) {
              var e,
                ...
                o = n.sort(ke).pop();
              for (
                Va = [], Ba = new Array(n.length), Xa = new me(), Wa = new me();
                ;
                ...
                if (
                  ...
                  (o.x === e && o.y === r) ||
                    ((Ba[o.i] = new oe(o)), ee(o), (e = o.x), (r = o.y)),
                    (o = n.pop());
                else {
                  if (!i) break;
                  te(i.arc);
            ...
            function Ce(n, t, e, r, i, o) {
              if (!n(t, e, r, i, o)) {
                var u = 0.5 * (e + i),
                  a = 0.5 * (r + o),
                  c = t.nodes;
                c[0] && Ce(n, c[0], e, r, u, a),
                  c[1] && Ce(n, c[1], u, r, i, a),
                  c[2] && Ce(n, c[2], e, a, u, o),
                  c[3] && Ce(n, c[3], u, a, i, o);
              }
            }
            function ze(n, t) {
            ...
            function qe(n, t) {
              ...
              for (
                ...
                e.index && l.push(t.substring(a, (c = e.index))),
                  ...
                  (a = Qa.lastIndex);
              for (
                a < t.length && l.push(t.substring(a)), r = 0, o = s.length;
                (e = Qa.exec(n)) && r < o;
                ++r
              )
                if (((u = s[r]), u.x == e[0])) {
                  if (u.i)
                    if (null == l[u.i + 1])
                      for (
                        l[u.i - 1] += u.x, l.splice(u.i, 1), i = r + 1;
                        i < o;
                        ++i
                      )
                        s[i].i--;
              ...
              for (; r < o; )
                (u = s.pop()),
                  null == l[u.i + 1]
                    ? (l[u.i] = u.x)
                    : ((l[u.i] = u.x + l[u.i + 1]), l.splice(u.i + 1, 1)),
                  o--;
              return 1 === l.length
                ? null == l[0]
                  ? ((u = s[0].x),
            ...
            function Re(n, t) {
              for (
                var e, r = Wo.interpolators.length;
                --r >= 0 && !(e = Wo.interpolators[r](n, t));
            ...
            function Be(n, t) {
              ...
              return (
                ...
                arguments.length
                  ? (e = (t / Eu) * Math.asin(1 / n))
                  : ((n = 1), (e = t / 4)),
                function (r) {
                  return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * Eu) / t)
                  );
                }
              );
            }
            ...
            function Qe(n) {
              ...
              t[0] * e[1] < e[0] * t[1] &&
                ((t[0] *= -1), (t[1] *= -1), (r *= -1), (i *= -1)),
                (this.rotate =
                  (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Tu),
                (this.translate = [n.e, n.f]),
                (this.scale = [r, o]),
                (this.skew = o ? Math.atan2(i, o) * Tu : 0);
            }
            function nr(n, t) {
            ...
            function ur(n) {
              for (
                var t = n.source, e = n.target, r = cr(t, e), i = [t];
                t !== r;
            ...
            function cr(n, t) {
              if (n === t) return n;
              for (
                var e = ar(n), r = ar(t), i = e.pop(), o = r.pop(), u = null;
                i === o;
            ...
            function pr(n, t, e) {
              ...
              if (((n.charge = 0), !n.leaf))
                for (var o, u = n.nodes, a = u.length, c = -1; ++c < a; )
                  (o = u[c]),
                    null != o &&
                      (pr(o, t, e),
                      (n.charge += o.charge),
            ...
            function gr(n, t) {
              return (
                Wo.rebind(n, t, "sort", "children", "value"),
                (n.nodes = n),
                (n.links = mr),
                n
              );
            ...
            function ai(n, t, e, r) {
              ...
              for (
                ...
                i.push(e(n[u - 1], n[u])), o.push(r(t[u - 1], t[u]));
              return function (t) {
            ...
            function pi(n, t, e) {
              ...
              return Wo.format(
                e
                  ? e.replace(ia, function (n, t, e, i, o, u, a, c, l, s) {
            ...
            function vi(n, t, e, r) {
              ...
              return (
                ...
                (u.domain = function (t) {
                  return arguments.length
                    ? ((e = t[0] >= 0), n.domain((r = t.map(Number)).map(i)), u)
                    : r;
                }),
                (u.base = function (e) {
                  return arguments.length
                    ? ((t = +e), n.domain(r.map(i)), u)
                    : t;
                }),
                (u.nice = function () {
                ...
                (u.tickFormat = function (n, t) {
                  ...
                  arguments.length < 2
                    ? (t = fc)
                    : "function" != typeof t && (t = Wo.format(t));
                  var r,
                    a = Math.max(0.1, n / u.ticks().length),
                    c = e
                      ? ((r = 1e-12), Math.ceil)
                      : ((r = -1e-12), Math.floor);
                  return function (n) {
            ...
            function xi(n, t) {
              function e(e) {
                return u[
                  ((o.get(e) || ("range" === t.t && o.set(e, n.push(e)))) - 1) %
                    u.length
                ];
              }
              function r(t, e) {
              ...
              return (
                (e.domain = function (r) {
                  ...
                  (n = []), (o = new i());
                  for (var u, a = -1, c = r.length; ++a < c; )
                    o.has((u = r[a])) || o.set(u, n.push(u));
                  return e[t.t].apply(e, t.a);
                }),
                (e.range = function (n) {
                  return arguments.length
                    ? ((u = n), (a = 0), (t = { t: "range", a: arguments }), e)
                    : u;
                }),
                (e.rangePoints = function (i, o) {
                  ...
                  return (
                    (u = r(n.length < 2 ? (c + l) / 2 : c + (s * o) / 2, s)),
                    (a = 0),
            ...
            function Ai(n) {
              function t(t) {
                ...
                for (
                  ...
                  i.call(this, (c = t[f]), f)
                    ? s.push([+p.call(this, c, f), +g.call(this, c, f)])
                    : s.length && (u(), (s = []));
            ...
            function Ri(n, t) {
              return n.length < 4
                ? Ci(n)
                : n[1] + Pi(n.slice(1, n.length - 1), Ui(n, t));
            }
            function ji(n, t) {
              return n.length < 3
                ? Ci(n)
                : n[0] +
                    Pi(
                      (n.push(n[0]), n),
                      Ui([n[n.length - 2]].concat(n, [n[1]]), t)
                    );
            }
            function Di(n, t) {
            ...
            function Fi(n) {
              ...
              for (
                ...
                (t = n[r]), o.push(t[0]), u.push(t[1]);
              for (e.push(Yi(bc, o) + "," + Yi(bc, u)), --r; ++r < i; )
                (t = n[r]),
                  o.shift(),
                  o.push(t[0]),
                  u.shift(),
            ...
            function Hi(n) {
              for (
                ...
                (e = n[r % i]), u.push(e[0]), a.push(e[1]);
              for (t = [Yi(bc, u), ",", Yi(bc, a)], --r; ++r < o; )
                (e = n[r % i]),
                  u.shift(),
                  u.push(e[0]),
                  a.shift(),
            ...
            function Bi(n) {
              for (
                ...
                r[t] = (u + (u = Vi((i = o), (o = n[t + 1])))) / 2;
              return (r[t] = u), r;
            }
            function Xi(n) {
              for (
                var t, e, r, i, o = [], u = Bi(n), a = -1, c = n.length - 1;
                ++a < c;
                    ...
                    function (r) {
                      function i(r) {
                        return o.active > e
                          ? l()
                          : ((o.active = e),
                            u.event && u.event.start.call(n, s, t),
                      ...
                      function c(r) {
                        ...
                        for (var i = r / p, a = f(i), c = d.length; c > 0; )
                          d[--c].call(n, a);
                        return i >= 1
                          ? (u.event && u.event.end.call(n, s, t), l())
                          : void 0;
                      }
                      function l() {
                        return (
                          --o.count ? delete o[e] : delete n.__transition__, 1
                        );
                      }
                      var s = n.__data__,
                        f = u.ease,
            ...
            function so(n, t, e) {
              ...
              function u(n, r, o) {
                ...
                else for (; u < r; ) a.push(new Date(+u)), t(u, 1);
                return a;
              }
              function a(n, t, e) {
                try {
            ...
            function ho(n) {
              function t(t) {
                for (var r, i, o, u = [], a = -1, c = 0; ++a < e; )
                  37 === n.charCodeAt(a) &&
                    (u.push(n.substring(c, a)),
                    null != (i = nl[(r = n.charAt(++a))]) &&
                      (r = n.charAt(++a)),
                    (o = tl[r]) &&
                      (r = o(t, null == i ? ("e" === r ? " " : "0") : i)),
                    u.push(r),
                    (c = a + 1));
            ...
            function mo(n, t, e) {
              ...
              return r
                ? ((n.w = $c.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
            }
            function xo(n, t, e) {
              Vc.lastIndex = 0;
              ...
              return r
                ? ((n.w = Bc.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
            }
            function _o(n, t, e) {
              rl.lastIndex = 0;
            ...
            function wo(n, t, e) {
              ...
              return r
                ? ((n.m = Kc.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
            }
            function ko(n, t, e) {
              Wc.lastIndex = 0;
              ...
              return r
                ? ((n.m = Gc.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
            }
            function So(n, t, e) {
            ...
            function $o(n) {
              ...
              return (
                t.selectNode(Ko.body),
                t.createContextualFragment(n.responseText)
              );
            }
            var Wo = { version: "3.3.13" };
            Date.now ||
              (Date.now = function () {
                return +new Date();
              });
            ...
            (Wo.ascending = function (n, t) {
              ...
              (Wo.min = function (n, t) {
                ...
                if (1 === arguments.length) {
                  for (; ++i < o && !(null != (e = n[i]) && e <= e); )
                    e = void 0;
                  for (; ++i < o; ) null != (r = n[i]) && e > r && (e = r);
                } else {
                  for (
                    ;
                    ++i < o && !(null != (e = t.call(n, n[i], i)) && e <= e);
              ...
              (Wo.median = function (t, e) {
                return (
                  ...
                  (t = t.filter(n)),
                  t.length ? Wo.quantile(t.sort(Wo.ascending), 0.5) : void 0
                );
              }),
            ...
            (Wo.bisectLeft = uu.left),
              (Wo.bisect = Wo.bisectRight = uu.right),
              (Wo.shuffle = function (n) {
              ...
              (Wo.zip = function () {
                ...
                for (
                  var n = -1, e = Wo.min(arguments, t), r = new Array(e);
                  ++n < e;
            ...
            (Wo.nest = function () {
              function n(t, a, c) {
                ...
                for (
                  var l, s, f, h, p = -1, g = a.length, d = u[c++], v = new i();
                  ++p < g;

                )
                  (h = v.get((l = d((s = a[p]))))) ? h.push(s) : v.set(l, [s]);
                return (
                  t
                    ? ((s = t()),
                      (f = function (e, r) {
              ...
              r(o, {
                ...
                forEach: function (n) {
                  for (var t in this)
                    t.charCodeAt(0) === lu && n.call(this, t.substring(1));
                },
              }),
              (Wo.behavior = {}),
              (Wo.rebind = function (n, t) {
                for (var e, r = 1, i = arguments.length; ++r < i; )
                  n[(e = arguments[r])] = u(n, t, t[e]);
                return n;
              });
            ...
            (Wo.dispatch = function () {
              ...
              (l.prototype.on = function (n, t) {
                ...
                if (
                  (e >= 0 &&
                    ((r = n.substring(e + 1)), (n = n.substring(0, e))),
                  n)
                )
                  return arguments.length < 2
                    ? this[n].on(r)
            ...
            "function" == typeof Sizzle &&
              ...
              (vu = Sizzle.matchesSelector)),
              (Wo.selection = function () {
                return _u;
              });
              ...
              (yu.selectAll = function (n) {
                ...
                for (var i = -1, o = this.length; ++i < o; )
                  for (var u = this[i], a = -1, c = u.length; ++a < c; )
                    (e = u[a]) &&
                      (r.push((t = Jo(n.call(e, e.__data__, a, i)))),
                      (t.parentNode = e));
                return g(r);
              });
            var mu = {
            ...
            (Wo.ns = {
              ...
              qualify: function (n) {
                ...
                return (
                  ...
                  mu.hasOwnProperty(e) ? { space: mu[e], local: n } : n
                );
              },
            }),
              ...
              (yu.data = function (n, t) {
                function e(n, e) {
                  ...
                  if (t) {
                    var v,
                      ...
                      x = [];
                    for (r = -1; ++r < a; )
                      (v = t.call((o = n[r]), o.__data__, r)),
                        y.has(v) ? (d[r] = o) : y.set(v, o),
                        x.push(v);
                    for (r = -1; ++r < f; )
                      (v = t.call(e, (u = e[r]), r)),
                        (o = y.get(v))
                ...
                var r,
                  ...
                  a = this.length;
                if (!arguments.length) {
                  for (n = new Array((a = (r = this[0]).length)); ++u < a; )
                    (o = r[u]) && (n[u] = o.__data__);
                  return n;
                }
                var c = z([]),
                  l = g([]),
            ...
            var xu = [];
            (Wo.selection.enter = z),
              (Wo.selection.enter.prototype = xu),
              (xu.append = yu.append),
              (xu.empty = yu.empty),
              (xu.node = yu.node),
              (xu.call = yu.call),
              (xu.size = yu.size),
              (xu.select = function (n) {
                for (
                  var t, e, r, i, o, u = [], a = -1, c = this.length;
                  ++a < c;
                  ...
                  for (var l = -1, s = i.length; ++l < s; )
                    (o = i[l])
                      ? (t.push(
                          (r[l] = e = n.call(i.parentNode, o.__data__, l, a))
                        ),
              ...
              (xu.insert = function (n, t) {
                return (
                  arguments.length < 2 && (t = T(this)),
                  yu.insert.call(this, n, t)
                );
              }),
              ...
              (Wo.behavior.drag = function () {
                ...
                function r(n, t, e, r) {
                  return function () {
                    ...
                    function a() {
                      y.on(e + "." + g, null).on(r + "." + g, null),
                        m(v && Wo.event.target === h),
                        f({ type: "dragend" });
                    }
                    var c,
                      l = this,
            ...
            (Wo.interpolateZoom = function (n, t) {
              ...
              (Wo.behavior.zoom = function () {
                ...
                function l() {
                  ...
                  function e() {
                    f.on(A, nu === r ? g : null).on(C, null),
                      p(s && Wo.event.target === l),
                      c(o);
                  }
                  var r = this,
                    o = T.of(r, arguments),
                ...
                function s() {
                  ...
                  function e() {
                    for (
                      var t = Wo.event.changedTouches, e = 0, o = t.length;
                      e < o;
                      ++e
                    )
                  ...
                  function o() {
                    for (
                      var n, t, e, o, u = Wo.touches(g), c = 0, l = u.length;
                      c < l;
                      ++c, o = null
                    )
                  ...
                  function h() {
                    if (Wo.event.touches.length) {
                      for (
                        var t = Wo.event.changedTouches, e = 0, r = t.length;
                        e < r;
                        ++e
                      )
                ...
                function h() {
                  ...
                  m ? clearTimeout(m) : (L.call(this), u(n)),
                ...
                function d() {
                  ...
                  u(n),
                    r(
                      Math.pow(
                        2,
                        Wo.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1
                      )
                    ),
                    i(e, o),
                    a(n),
                        ...
                        ? Wo.select(this)
                            ...
                            .tween("zoom:zoom", function () {
                              var e = S[0],
                                ...
                                i = e / 2,
                                o = r / 2,
                                u = Wo.interpolateZoom(
                                  [(i - k.x) / k.k, (o - k.y) / k.k, e / k.k],
                                  [(i - t.x) / t.k, (o - t.y) / t.k, e / t.k]
                                );
                              return function (t) {
                                var r = u(t),
                                  c = e / r[2];
                                (this.__chart__ = k =
                                  { x: i - r[0] * c, y: o - r[1] * c, k: c }),
                                  a(n);
                              };
                            })
            ...
            (Uu.brighter = function (n) {
              return (
                ...
                B(this.h, this.s, this.l / n)
              );
            }),
              (Uu.darker = function (n) {
                return (
                  (n = Math.pow(0.7, arguments.length ? n : 1)),
                  B(this.h, this.s, n * this.l)
                );
              }),
              (Uu.rgb = function () {
              ...
              (Wo.hcl = function (n, t, e) {
                return 1 === arguments.length
                  ? n instanceof G
                    ...
                    : n instanceof Q
                    ? tn(n.l, n.a, n.b)
                    : tn((n = pn((n = Wo.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
                  : W(+n, +t, +e);
              });
            ...
            (Ou.brighter = function (n) {
              return W(
                this.h,
                this.c,
                Math.min(100, this.l + Fu * (arguments.length ? n : 1))
              );
            }),
              (Ou.darker = function (n) {
                return W(
                  this.h,
                  this.c,
                  Math.max(0, this.l - Fu * (arguments.length ? n : 1))
                );
              }),
              (Ou.rgb = function () {
            ...
            Bu.forEach(function (n, t) {
              ...
              (Wo.csv = Wo.dsv(",", "text/csv")),
              (Wo.tsv = Wo.dsv("\t", "text/tab-separated-values"));
            var Xu,
              $u,
              Wu,
              Gu,
            ...
            (Wo.timer = function (n, t, e) {
              ...
              var i = e + t,
                o = { c: n, t: i, f: !1, n: null };
              $u ? ($u.n = o) : (Xu = o),
                ($u = o),
                Wu || ((Gu = clearTimeout(Gu)), (Wu = 1), Ku(Mn));
            }),
            ...
            (Wo.formatPrefix = function (n, t) {
              ...
              return (
                n &&
                  (n < 0 && (n *= -1),
                  t && (n = Wo.round(n, Sn(n, t))),
                  (e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10)),
                  (e = Math.max(
                    -24,
                    Math.min(24, 3 * Math.floor((e <= 0 ? e + 1 : e - 1) / 3))
                  ))),
                ra[8 + e / 3]
              );
            }),
                ...
                return function (n) {
                  ...
                  return (
                    ...
                    ("<" === r
                      ...
                      ? _ + t + n
                      : "^" === r
                      ? _.substring(0, (x >>= 1)) + t + n + _.substring(x)
                      : t + (g ? n : _ + n)) + h
                  );
                };
              });
            var ia =
              ...
              oa = Wo.map({
                ...
                r: function (n, t) {
                  return (n = Wo.round(n, Sn(n, t))).toFixed(
                    Math.max(0, Math.min(20, Sn(n * (1 + 1e-15), t)))
                  );
                },
              }),
              ua = yn;
            if (ta) {
              ...
              ua = function (n) {
                for (
                  var t = n.length, e = [], r = 0, i = ta[0];
                  t > 0 && i > 0;

                )
                  e.push(n.substring((t -= i), t + i)),
                    (i = ta[(r = (r + 1) % aa)]);
            ...
            (Wo.geo = {}),
              (Nn.prototype = {
                ...
                add: function (n) {
                  An(n, this.t, ca),
                    An(ca.s, this.s, this),
                    this.s ? (this.t += ca.t) : (this.s = ca.t);
                },
                reset: function () {
                  this.s = this.t = 0;
                },
            ...
            var fa,
              ...
              pa = {
                ...
                polygonEnd: function () {
                  var n = 2 * ha;
                  (fa += n < 0 ? 4 * Su + n : n),
                    (pa.lineStart = pa.lineEnd = pa.point = c);
                },
              };
            (Wo.geo.bounds = (function () {
                  ...
                  for (var e, r = 1, i = x[0], o = [i]; r < t; ++r)
                    (e = x[r]),
                      l(e[0], i) || l(e[1], i)
                        ...
                        : o.push((i = e));
                  for (
                    var u, e, g = -(1 / 0), t = o.length - 1, r = 0, i = o[t];
                    r <= t;
                    i = e, ++r
                  )
                    (e = o[r]),
              ...
              (Wo.geo.centroid = function (n) {
                (ga = da = va = ya = ma = xa = _a = Ma = ba = wa = ka = 0),
                  Wo.geo.stream(n, Sa);
                var t = ba,
                  e = wa,
                  r = ka,
                ...
                return i < Cu &&
                  ...
                  (e = _a),
                  (r = Ma),
                  da < Au && ((t = va), (e = ya), (r = ma)),
                  (i = t * t + e * e + r * r),
                  i < Cu)
                  ? [NaN, NaN]
                  : [Math.atan2(e, t) * Tu, F(r / Math.sqrt(i)) * Tu];
              });
            var ga,
              da,
              va,
              ...
              (Wo.geo.albersUsa = function () {
                ...
                return (
                  ...
                  (n.precision = function (t) {
                    return arguments.length
                      ? (o.precision(t), u.precision(t), a.precision(t), n)
                      : o.precision();
                  }),
                  (n.scale = function (t) {
                    return arguments.length
                  ...
                  (n.translate = function (t) {
                    ...
                    return (
                      ...
                      (r = u
                        ...
                        .clipExtent([
                          [s - 0.425 * l + Au, f + 0.12 * l + Au],
                          [s - 0.214 * l - Au, f + 0.234 * l - Au],
                        ])
                        .stream(c).point),
                      (i = a
                        .translate([s - 0.205 * l, f + 0.212 * l])
                        .clipExtent([
                          [s - 0.214 * l + Au, f + 0.166 * l + Au],
                          [s - 0.115 * l - Au, f + 0.234 * l - Au],
                        ])
                        .stream(c).point),
                      n
                    );
            ...
            var Aa,
              ...
              Ra = {
                ...
                polygonEnd: function () {
                  (Ra.lineStart = Ra.lineEnd = Ra.point = c),
                    (Aa += au(Ca / 2));
                },
              },
              ja = {
            ...
            (Wo.geo.path = function () {
              ...
              return (
                ...
                (n.centroid = function (n) {
                  return (
                    (va = ya = ma = xa = _a = Ma = ba = wa = ka = 0),
                    Wo.geo.stream(n, i(Da)),
                    ka
                      ? [ba / ka, wa / ka]
                      : Ma
                      ? [xa / Ma, _a / Ma]
                ...
                (n.projection = function (n) {
                  return arguments.length
                    ? ((i = (e = n) ? n.stream || _t(n) : yn), t())
                    : e;
                }),
                (n.context = function (n) {
                  return arguments.length
                    ? ((o = null == (r = n) ? new ht() : new mt(n)),
                ...
                (n.pointRadius = function (t) {
                  return arguments.length
                    ? ((a =
                        "function" == typeof t ? t : (o.pointRadius(+t), +t)),
                      n)
                    : a;
                }),
              ...
              (Wo.geo.projection = wt),
              (Wo.geo.projectionMutator = kt),
              ((Wo.geo.equirectangular = function () {
                return wt(Et);
              }).raw = Et.invert =
                Et),
              (Wo.geo.rotation = function (n) {
                function t(t) {
                  return (
                    (t = n(t[0] * zu, t[1] * zu)), (t[0] *= Tu), (t[1] *= Tu), t
                  );
                }
                return (
                  (n = At(
              ...
              (Wo.geo.graticule = function () {
                ...
                function t() {
                  return Wo.range(Math.ceil(o / v) * v, i, v)
                    .map(h)
                    .concat(Wo.range(Math.ceil(l / y) * y, c, y).map(p))
                    .concat(
                      Wo.range(Math.ceil(r / g) * g, e, g)
                        .filter(function (n) {
                          return au(n % v) > Au;
                        })
                        .map(s)
            ...
            ((Wo.geo.azimuthalEquidistant = function () {
              ...
              ((Wo.geo.conicConformal = function () {
                return ct(Ht);
              }).raw = Ht),
              ((Wo.geo.conicEquidistant = function () {
                return ct(It);
              }).raw = It);
            ...
            ((Wo.geo.stereographic = function () {
              ...
              (Wo.geom.hull = function (n) {
                function t(n) {
                  ...
                  for (o = 1; o < y; ++o)
                    (t[o][1] < t[M][1] ||
                      (t[o][1] == t[M][1] && t[o][0] < t[M][0])) &&
                      (M = o);
                  for (o = 0; o < y; ++o)
                    o !== M &&
                      ((c = t[o][1] - t[M][1]),
                      (a = t[o][0] - t[M][0]),
                      x.push({ angle: Math.atan2(c, a), index: o }));
                  for (
                    x.sort(function (n, t) {
                  ...
                  for (_.push(M), o = 0, u = 0; o < 2; ++u)
                    x[u].index > -1 && (_.push(x[u].index), o++);
              ...
              (Za.clip = function (n) {
                for (
                  ...
                  for (
                    ...
                    (u = t[e]),
                      Wt(u, s, i)
                        ? (Wt(o, s, i) || n.push(Gt(o, u, s, i)), n.push(u))
                        : Wt(o, s, i) && n.push(Gt(o, u, s, i)),
                      (o = u);
                  a && n.push(n[0]), (s = i);
                }
                return n;
                    ...
                    do {
                      ...
                      if (n === i.L) {
                        if (
                          ((t = i.R),
                          t.C &&
                            ((t.C = !1), (i.C = !0), _e(this, i), (t = i.R)),
                          (t.L && t.L.C) || (t.R && t.R.C))
                        ) {
                          (t.R && t.R.C) ||
                            ((t.L.C = !1), (t.C = !0), Me(this, t), (t = i.R)),
                            (t.C = i.C),
                            (i.C = t.R.C = !1),
                            _e(this, i),
                            (n = this._);
                        ...
                        ((t = i.L),
                        t.C && ((t.C = !1), (i.C = !0), Me(this, i), (t = i.L)),
                        (t.L && t.L.C) || (t.R && t.R.C))
                      ) {
                        (t.L && t.L.C) ||
                          ((t.R.C = !1), (t.C = !0), _e(this, t), (t = i.L)),
                          (t.C = i.C),
                          (i.C = t.L.C = !1),
                          Me(this, i),
                          (n = this._);
              ...
              (Wo.geom.voronoi = function (n) {
                function t(n) {
                  var t = new Array(n.length),
                    ...
                    u = a[1][1];
                  return (
                    we(e(n), a).cells.forEach(function (e, a) {
                      var c = e.edges,
                        l = e.site,
                        s = (t[a] = c.length
                          ? c.map(function (n) {
                ...
                return n
                  ...
                  : ((t.links = function (n) {
                    ...
                    (t.triangles = function (n) {
                      var t = [];
                      return (
                        we(e(n)).cells.forEach(function (e, r) {
                          for (
                            var i,
                              o,
                              u = e.site,
            ...
            (Wo.geom.delaunay = function (n) {
              ...
              (Wo.interpolateRgb = ze),
              (Wo.interpolateObject = Te),
              (Wo.interpolateNumber = Le),
              (Wo.interpolateString = qe);
            var Qa = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
            (Wo.interpolate = Re),
              (Wo.interpolators = [
                function (n, t) {
            ...
            (Wo.ease = function (n) {
              ...
              return (
                (e = tc.get(e) || nc),
                (r = ec.get(r) || yn),
                De(r(e.apply(null, Go.call(arguments, 1))))
              );
            }),
              (Wo.interpolateHcl = We),
              (Wo.interpolateHsl = Ge),
              (Wo.interpolateLab = Je),
              (Wo.interpolateRound = Ke),
              (Wo.transform = function (n) {
            ...
            var rc = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 };
            (Wo.interpolateTransform = rr),
              (Wo.layout = {}),
              (Wo.layout.bundle = function () {
                return function (n) {
                  ...
                  (a.tick = function () {
                    ...
                    for (e = 0; e < b; ++e)
                      (a = y[e]),
                        ...
                        (_ = h.y - f.y),
                        (d = x * x + _ * _) &&
                          ((d = (r * o[e] * ((d = Math.sqrt(d)) - i[e])) / d),
                          (x *= d),
                          (_ *= d),
                          (h.x -= x * (m = f.weight / (h.weight + f.weight))),
                          (h.y -= _ * m),
                          (f.x += x * (m = 1 - m)),
                          (f.y += _ * m));
                    if (
                      (m = r * g) &&
                      ((x = l[0] / 2), (_ = l[1] / 2), (e = -1), m)
                    )
                      for (; ++e < M; )
                        (a = v[e]),
                          (a.x += (x - a.x) * m),
                    ...
                    if (p)
                      for (
                        pr((t = Wo.geom.quadtree(v)), r, u), e = -1;
                        ++e < M;
                    ...
                    return (
                      e ||
                        (e = Wo.behavior
                          .drag()
                          .origin(yn)
                          .on("dragstart.force", lr)
                          .on("drag.force", t)
                          .on("dragend.force", sr)),
                      arguments.length
                        ? void this.on("mouseover.force", fr)
                            .on("mouseout.force", hr)
                            .call(e)
                        : e
                    );
                  }),
                ...
                if (((t.depth = u), a.push(t), c && (l = c.length))) {
                  for (
                    var l,
                      s,
                      f = -1,
                      h = (t.children = new Array(l)),
                      p = 0,
                      g = u + 1;
                    ++f < l;

                  )
                    (s = h[f] = n(c[f], g, a)), (s.parent = t), (p += s.value);
                  r && h.sort(r), o && (t.value = p);
                } else
                  delete t.children, o && (t.value = +o.call(e, t, u) || 0);
                return t;
              }
              function t(n, r) {
                var i = n.children,
            ...
            Wo.layout.stack = function () {
              function n(a, c) {
                ...
                for (p = 0; p < y; ++p)
                  for (
                    i.call(n, l[0][p], (g = d[p]), s[0][p][1]), h = 1;
                    h < v;
                    ++h
                  )
                    i.call(n, l[h][p], (g += s[h - 1][p][1]), s[h][p][1]);
                return a;
              }
              var t = yn,
                e = br,
              ...
              return (
                ...
                (n.order = function (t) {
                  return arguments.length
                    ? ((e = "function" == typeof t ? t : ac.get(t) || br), n)
                    : e;
                }),
                (n.offset = function (t) {
                  return arguments.length
                    ? ((r = "function" == typeof t ? t : cc.get(t) || wr), n)
                    : r;
                }),
                (n.x = function (t) {
                  return arguments.length ? ((o = t), n) : o;
            ...
            (Wo.layout.histogram = function () {
              function n(n, o) {
                for (
                  ...
                  (u = c[o] = []), (u.dx = f[o + 1] - (u.x = f[o])), (u.y = 0);
                if (p > 0)
                  for (o = -1; ++o < h; )
                    (a = l[o]),
                      a >= s[0] &&
                        a <= s[1] &&
                        ((u = c[Wo.bisect(f, a, 1, p) - 1]),
                        (u.y += g),
                        u.push(n[o]));
                return c;
              }
                ...
                function n(n, o) {
                  function u(n, t) {
                    var r = n.children,
                      i = n._tree;
                    if (r && (o = r.length)) {
                      for (var o, a, l, s = r[0], f = s, h = -1; ++h < o; )
                        (l = r[h]), u(l, a), (f = c(l, a, f)), (a = l);
                      Ur(n);
                      var p = 0.5 * (s._tree.prelim + l._tree.prelim);
                      t
                    ...
                    if (t) {
                      for (
                        ...
                        (c = Tr(c)),
                          ...
                          (u._tree.ancestor = n),
                          (i =
                            a._tree.prelim + f - o._tree.prelim - l + e(a, o)),
                          i > 0 && (Or(Fr(a, n, r), n, i), (l += i), (s += i)),
                          (f += a._tree.mod),
                          (l += o._tree.mod),
                          (h += c._tree.mod),
                          (s += u._tree.mod);
                      a &&
                        !Lr(u) &&
                        ((u._tree.thread = a), (u._tree.mod += f - s)),
                        o &&
                          !Tr(c) &&
                          ((c._tree.thread = o),
                          (c._tree.mod += l - h),
              ...
              (Wo.layout.treemap = function () {
                ...
                function e(t) {
                  ...
                  if (r && r.length) {
                    var o,
                      ...
                      c = [];
                    for (
                      n(a, (u.dx * u.dy) / t.value), c.area = 0;
                      (o = a.pop());
                ...
                function r(n, t) {
                  ...
                  return (
                    (r *= r),
                    (t *= t),
                    r ? Math.max((t * i * g) / r, r / (t * o * g)) : 1 / 0
                  );
                }
                function i(n, t, e, r) {
                  var i,
                    ...
                    s = t ? c(n.area / t) : 0;
                  if (t == e.dx) {
                    for ((r || s > e.dy) && (s = e.dy); ++o < u; )
                      (i = n[o]),
                        (i.x = a),
                        (i.y = l),
                        (i.dy = s),
                        (a += i.dx =
                          Math.min(e.x + e.dx - a, s ? c(i.area / s) : 0));
                    (i.z = !0),
                      (i.dx += e.x + e.dx - a),
                      (e.y += s),
                      (e.dy -= s);
                  } else {
                    for ((r || s > e.dx) && (s = e.dx); ++o < u; )
                      (i = n[o]),
                        (i.x = a),
                        (i.y = l),
                        (i.dx = s),
                        (l += i.dy =
                          Math.min(e.y + e.dy - l, s ? c(i.area / s) : 0));
                    (i.z = !1),
                      (i.dy += e.y + e.dy - l),
                      (e.x += s),
                      (e.dx -= s);
                ...
                return (
                  ...
                  (o.padding = function (n) {
                    function t(t) {
                      ...
                      return null == e
                        ? ni(t)
                        : ti(t, "number" == typeof e ? [e, e, e, e] : e);
                    }
                    function e(t) {
                      return ti(t, n);
                    }
              ...
              (Wo.scale = {});
            var lc = { floor: yn, ceil: yn };
            Wo.scale.linear = function () {
              return ci([0, 1], [0, 1], Re, !1);
            };
            var sc = { s: 1, g: 1, p: 1, r: 1, e: 1 };
            ...
            (Wo.scale.pow = function () {
              ...
              (Wo.scale.sqrt = function () {
                return Wo.scale.pow().exponent(0.5);
              }),
            ...
            (Ac.call = yu.call),
              ...
              (Ac.select = function (n) {
                ...
                for (var u = -1, a = this.length; ++u < a; ) {
                  o.push((t = []));
                  for (var c = this[u], l = -1, s = c.length; ++l < s; )
                    (r = c[l]) && (e = n.call(r, r.__data__, l, u))
                      ? ("__data__" in r && (e.__data__ = r.__data__),
                        uo(e, l, i, r.__transition__[i]),
                        t.push(e))
                      : t.push(null);
                }
                return ro(o, i);
              ...
              (Ac.selectAll = function (n) {
                ...
                for (var c = -1, l = this.length; ++c < l; )
                  for (var s = this[c], f = -1, h = s.length; ++f < h; )
                    if ((r = s[f])) {
                      (o = r.__transition__[u]),
                        (e = n.call(r, r.__data__, f, c)),
                        a.push((t = []));
                      for (var p = -1, g = e.length; ++p < g; )
                        (i = e[p]) && uo(i, p, u, o), t.push(i);
                    }
                return ro(a, u);
              }),
              (Ac.filter = function (n) {
                ...
                for (var o = 0, u = this.length; o < u; o++) {
                  i.push((t = []));
                  for (var e = this[o], a = 0, c = e.length; a < c; a++)
                    (r = e[a]) && n.call(r, r.__data__, a, o) && t.push(r);
                }
                return ro(i, this.id);
              }),
              ...
              (Ac.styleTween = function (n, t, e) {
                function r(r, i) {
                  var o = t.call(
                    ...
                    r,
                    i,
                    nu.getComputedStyle(this, null).getPropertyValue(n)
                  );
                  return (
                    o &&
                    function (t) {
              ...
              (Ac.each = function (n, t) {
                ...
                if (arguments.length < 2) {
                  ...
                  C(this, function (r) {
                    ...
                    (i.event || (i.event = Wo.dispatch("start", "end"))).on(
                      n,
                      t
                    );
                  });
              ...
              (Ac.transition = function () {
                for (
                  ...
                  u.push((n = []));
                  for (var t = this[a], l = 0, s = t.length; l < s; l++)
                    (e = t[l]) &&
                  ...
                  n.each(function () {
                    ...
                    switch (r) {
                      case "bottom":
                        (n = ao),
                          M.attr("y2", i),
                          k.attr("y", Math.max(i, 0) + u),
                          b.attr("x2", 0).attr("y2", i),
                          S.attr("x", 0).attr("y", Math.max(i, 0) + u),
                      ...
                      case "left":
                        (n = co),
                          M.attr("x2", -i),
                          k.attr("x", -(Math.max(i, 0) + u)),
                          b.attr("x2", -i).attr("y2", 0),
                          S.attr("x", -(Math.max(i, 0) + u)).attr("y", 0),
            ...
            var zc = "bottom",
              Tc = { top: 1, right: 1, bottom: 1, left: 1 };
            Wo.svg.brush = function () {
              function n(o) {
                o.each(function () {
                  var o = Wo.select(this)
              ...
              function i() {
                function i() {
                  32 == Wo.event.keyCode &&
                    (A || ((x = null), (z[0] -= s[1]), (z[1] -= h[1]), (A = 2)),
                    f());
                }
                function p() {
                  32 == Wo.event.keyCode &&
                    2 == A &&
                    ((z[0] += s[1]), (z[1] += h[1]), (A = 0), f());
                }
                function v() {
                  var n = Wo.mouse(M),
                    i = !1;
                  _ && ((n[0] += _[0]), (n[1] += _[1])),
                    ...
                    N && y(n, l, 1) && (r(k), (i = !0)),
                    i &&
                      (t(k), w({ type: "brush", mode: A ? "move" : "resize" }));
                }
                function y(n, t, e) {
                  var r,
                    i,
                  ...
                  if (
                    (A && ((c -= f), (l -= v + f)),
                    (r = (e ? d : g) ? Math.max(c, Math.min(l, n[e])) : n[e]),
                    A
                      ? (i = (r += f) + v)
                      : (x && (f = Math.max(c, Math.min(l, 2 * x[e] - r))),
                        f < r ? ((i = r), (r = f)) : (i = f)),
                    p[0] != r || p[1] != i)
                  )
                    return (
                      e ? (u = null) : (o = null), (p[0] = r), (p[1] = i), !0
                    );
                }
                function m() {
                  v(),
                    ...
                    Wo.select("body").style("cursor", null),
                ...
                k
                  ...
                  .selectAll(".resize")
                  .style("display", null),
                  Wo.select("body").style("cursor", b.style("cursor")),
                  w({ type: "brushstart" }),
                  v();
              }
              var o,
                u,
                a = p(n, "brushstart", "brush", "brushend"),
                c = null,
                l = null,
                s = [0, 0],
                h = [0, 0],
              ...
              return (
                    ...
                    : (c &&
                      ...
                      l &&
                        (u
                          ...
                          : ((i = h[0]),
                            (a = h[1]),
                            l.invert && ((i = l.invert(i)), (a = l.invert(a))),
                            a < i && ((f = i), (i = a), (a = f)))),
                      c && l
                        ? [
                            [e, i],
                ...
                (n.clear = function () {
                  return (
                    n.empty() || ((s = [0, 0]), (h = [0, 0]), (o = u = null)), n
                  );
                }),
                (n.empty = function () {
              ...
              Dc.forEach(function (n, t) {
                ...
                var e = (Rc[n] = so(
                  ...
                  function (n) {
                    ...
                    return (
                      Math.floor((Rc.dayOfYear(n) + ((e + t) % 7)) / 7) -
                      (e !== t)
                    );
                  }
                ));
      ...
      7: [
        function (n, t, e) {
          var r = Object.prototype.hasOwnProperty,
            ...
            o = function (n) {
              var t =
                ("function" == typeof n && !(n instanceof RegExp)) ||
          ...
          t.exports = function (n, t) {
            ...
            if (a === +a)
              for (e = 0; e < a; e++)
                null === c
                  ? t(u ? n.charAt(e) : n[e], e, n)
                  : t.call(c, u ? n.charAt(e) : n[e], e, n);
            else
              for (i in n)
                r.call(n, i) &&
                  (null === c ? t(n[i], i, n) : t.call(c, n[i], i, n));
          };
        },
        {},
      ],
            ...
            (e = function (n) {
              ...
              if (s)
                ...
                var h,
                  p = c && e;
                for (h in n)
                  (p && "prototype" === h) || !r.call(n, h) || f.push(h);
              }
              if (a) {
                var g = n.constructor,
                  d = g && g.prototype === n;
